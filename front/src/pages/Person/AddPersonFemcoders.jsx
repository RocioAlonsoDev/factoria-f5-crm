...
export default function AddPersonFemcoders() {
        ...
        <div className="relative flex flex-col min-w-0 break-words w-full m-6 ">
              ...
              <div className="text-center mb-3">
                ...
                <h4 className="text-orange-500 text-xl  m-6">
                  ¿Eres <strong>Mujer</strong> y quieres vivir la experiencia de aprender a desarrollar entre mujeres? Inscríbete aquí para obtener más información sobre nuestro bootcamp <strong>FemCoders</strong>.
                </h4>
              </div>
            </div>
                ...
                {section === 3 && (
                  <div className="section">
                    ...
                    <InputField
                      ...
                      onChange={handleChange}
                    />
                    <label className="block uppercase text-blueGray-600 text-xs font-bold mb-2">Al enviar confirmo que soy Mujer</label>
