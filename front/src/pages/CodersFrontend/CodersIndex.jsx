...
export default function CodersIndex() {
  ...
  const data = coders.map((coder) => ({
    ...
    '' : (<>
    <ButtonAtom addlink={`/tracking/coders/${coder.id}/evaluation`} addbutton='Evaluación'></ButtonAtom>
    <ButtonAtom addlink={`/tracking/coders/${coder.id}/projectsWorkshops`} addbutton='Proyectos'></ButtonAtom>
