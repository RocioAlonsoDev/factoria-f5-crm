...
export default function StepAtom(props) {
  ...
  return (
    ...
    <div className="relative flex flex-col min-w-0 break-words px-8 bg-white w-full mb-6 shadow-lg rounded">
      ...
      <div className="rounded-t mb-0 px-4 py-8 border-0">
        <div className="flex flex-wrap items-center">
          <div className="relative w-full px-1 max-w-full flex-grow flex-1">
            <h3 className="font-semibold text-blueGray-700 text-2xl text-center">{formTitle}</h3>
          </div>
        </div>
      </div>
